...
* class ^binding.extension[+].url = "http://hl7.org/fhir/tools/StructureDefinition/additional-binding"
* class ^binding.extension[=].extension[+].url = "purpose"
* class ^binding.extension[=].extension[=].valueCode = #preferred
* class ^binding.extension[=].extension[+].url = "valueSet"
* class ^binding.extension[=].extension[=].valueCanonical = "https://terminologia.saude.gov.br/fhir/ValueSet/BRModalidadeAssistencial"
...
* reasonCode ^binding.extension[=].extension[=].valueCode = #preferred
* reasonCode ^binding.extension[=].extension[+].url = "valueSet"
* reasonCode ^binding.extension[=].extension[=].valueCanonical = "https://terminologia.saude.gov.br/fhir/ValueSet/BRCIAP2"
...
* hospitalization.dischargeDisposition from https://terminologia.saude.gov.br/fhir/ValueSet/BRMotivoDesfecho (example)
