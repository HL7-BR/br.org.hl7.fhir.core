...
* subject.id ^definition = "Identificador único para referencia cruzada"
...
* stage.id ^short = "Identificador único para referencia cruzada"
* stage.id ^definition = "Identificador único para referencia cruzada"
...
* evidence.id ^short = "Identificador único para referencia cruzada"
* evidence.id ^definition = "Identificador único para referencia cruzada"
