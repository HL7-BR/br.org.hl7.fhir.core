...
* participant.required ^short = "required | optional | information-only"
* participant.required ^definition = "required | optional | information-only"
* participant.status ^short = "accepted | declined | tentative | needs-action"
* participant.status ^definition = "accepted | declined | tentative | needs-action"
* participant.period ^short = "Período de participação do ator"
* participant.period ^definition = "Período de participação do ator"
* requestedPeriod ^short = "Possíveis intervalos de data/hora solicitados para alocar o compromisso dentro"
* requestedPeriod ^definition = "Possíveis intervalos de data/hora solicitados para alocar o compromisso dentro"
