...
* identifier[cns] ^short = "Identificador do profissional (CNS)"
...
* identifier[cns].assigner ^short = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[cns].assigner ^definition = "Referência à organização que atribuiu o identificador ao estabelecimento"
...
* identifier[cns].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[cns].assigner.extension ^short = "Extensões adicionais definidas pela implementação"
* identifier[cns].assigner.extension ^definition = "Extensões adicionais definidas pela implementação"
...
* identifier[cns].assigner.type ^short = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[cns].assigner.type ^definition = "Tipo referenciado (p. ex. br-core-patient)"
...
* identifier[cns].assigner.display ^short = "Nome da entidade que atribuiu o identificador da organização"
* identifier[cns].assigner.display ^definition = "Nome da entidade que atribuiu o identificador da organização"
* identifier[cpf] ^short = "Identificador do profissional (CPF)"
...
* identifier[identificadorMedico] ^short = "Identificador médico"
* identifier[identificadorMedico] ^definition = "Identificador identificador médico"
...
* identifier[identificadorMedico].assigner ^short = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorMedico].assigner ^definition = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorMedico].assigner only Reference(br-core-organization)
* identifier[identificadorMedico].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorMedico].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorMedico].assigner.extension ^short = "Extensões adicionais definidas pela implementação"
* identifier[identificadorMedico].assigner.extension ^definition = "Extensões adicionais definidas pela implementação"
* identifier[identificadorMedico].assigner.reference ^short = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorMedico].assigner.reference ^definition = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorMedico].assigner.type ^short = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorMedico].assigner.type ^definition = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorMedico].assigner.identifier ^short = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorMedico].assigner.identifier ^definition = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorMedico].assigner.display ^short = "Nome da entidade que atribuiu o identificador da organização"
* identifier[identificadorMedico].assigner.display ^definition = "Nome da entidade que atribuiu o identificador da organização"
...
* identifier[identificadorFarmaceutico].assigner ^short = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorFarmaceutico].assigner ^definition = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorFarmaceutico].assigner only Reference(br-core-organization)
* identifier[identificadorFarmaceutico].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorFarmaceutico].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorFarmaceutico].assigner.extension ^short = "Extensões adicionais definidas pela implementação"
* identifier[identificadorFarmaceutico].assigner.extension ^definition = "Extensões adicionais definidas pela implementação"
* identifier[identificadorFarmaceutico].assigner.reference ^short = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorFarmaceutico].assigner.reference ^definition = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorFarmaceutico].assigner.type ^short = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorFarmaceutico].assigner.type ^definition = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorFarmaceutico].assigner.identifier ^short = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorFarmaceutico].assigner.identifier ^definition = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorFarmaceutico].assigner.display ^short = "Nome da entidade que atribuiu o identificador da organização"
* identifier[identificadorFarmaceutico].assigner.display ^definition = "Nome da entidade que atribuiu o identificador da organização"
...
* identifier[identificadorOdontologo].assigner ^short = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorOdontologo].assigner ^definition = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorOdontologo].assigner only Reference(br-core-organization)
* identifier[identificadorOdontologo].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorOdontologo].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorOdontologo].assigner.extension ^short = "Extensões adicionais definidas pela implementação"
* identifier[identificadorOdontologo].assigner.extension ^definition = "Extensões adicionais definidas pela implementação"
* identifier[identificadorOdontologo].assigner.reference ^short = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorOdontologo].assigner.reference ^definition = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorOdontologo].assigner.type ^short = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorOdontologo].assigner.type ^definition = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorOdontologo].assigner.identifier ^short = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorOdontologo].assigner.identifier ^definition = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorOdontologo].assigner.display ^short = "Nome da entidade que atribuiu o identificador da organização"
* identifier[identificadorOdontologo].assigner.display ^definition = "Nome da entidade que atribuiu o identificador da organização"
...
* identifier[identificadorEnfermeiro].assigner ^short = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorEnfermeiro].assigner ^definition = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorEnfermeiro].assigner only Reference(br-core-organization)
* identifier[identificadorEnfermeiro].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorEnfermeiro].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorEnfermeiro].assigner.extension ^short = "Extensões adicionais definidas pela implementação"
* identifier[identificadorEnfermeiro].assigner.extension ^definition = "Extensões adicionais definidas pela implementação"
* identifier[identificadorEnfermeiro].assigner.reference ^short = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorEnfermeiro].assigner.reference ^definition = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorEnfermeiro].assigner.type ^short = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorEnfermeiro].assigner.type ^definition = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorEnfermeiro].assigner.identifier ^short = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorEnfermeiro].assigner.identifier ^definition = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorEnfermeiro].assigner.display ^short = "Nome da entidade que atribuiu o identificador da organização"
* identifier[identificadorEnfermeiro].assigner.display ^definition = "Nome da entidade que atribuiu o identificador da organização"
...
* identifier[identificadorOutrosProfissionais].assigner ^short = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorOutrosProfissionais].assigner ^definition = "Referência à organização que atribuiu o identificador ao estabelecimento"
* identifier[identificadorOutrosProfissionais].assigner only Reference(br-core-organization)
* identifier[identificadorOutrosProfissionais].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorOutrosProfissionais].assigner.id ^short = "Identificador único para referência cruzada"
* identifier[identificadorOutrosProfissionais].assigner.extension ^short = "Extensões adicionais definidas pela implementação"
* identifier[identificadorOutrosProfissionais].assigner.extension ^definition = "Extensões adicionais definidas pela implementação"
* identifier[identificadorOutrosProfissionais].assigner.reference ^short = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorOutrosProfissionais].assigner.reference ^definition = "Referência literal, URL relativa, interna ou absoluta"
* identifier[identificadorOutrosProfissionais].assigner.type ^short = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorOutrosProfissionais].assigner.type ^definition = "Tipo referenciado (p. ex. br-core-patient)"
* identifier[identificadorOutrosProfissionais].assigner.identifier ^short = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorOutrosProfissionais].assigner.identifier ^definition = "Referência lógica, quando a referência literal não é conhecida"
* identifier[identificadorOutrosProfissionais].assigner.display ^short = "Nome da entidade que atribuiu o identificador da organização"
* identifier[identificadorOutrosProfissionais].assigner.display ^definition = "Nome da entidade que atribuiu o identificador da organização"
...
* name.extension ^short = "Extensões adicionais que não podem ser ignoradas, mesmo que não reconhecidas"
* name.extension ^definition = "Extensões adicionais que não podem ser ignoradas, mesmo que não reconhecidas"
...
* name.text ^short = "Nome do Profissional"
* name.text ^definition = "Nome do Profissional"
* name.family ^short = "Sobrenome do profissional"
* name.family ^definition = "Sobrenome do profissional"
* name.given ^short = "Nome completo do Profissional"
* name.given ^definition = "Nome completo do Profissional"
...
* qualification.extension ^short = " Extensões adicionais que não podem ser ignoradas, mesmo que não reconhecidas"
* qualification.extension ^definition = " Extensões adicionais que não podem ser ignoradas, mesmo que não reconhecidas"
...
* qualification.code.coding.userSelected ^short = "Se este código foi escolhido diretamente pelo usuário"
* qualification.code.coding.userSelected ^definition = "Se este código foi escolhido diretamente pelo usuário"
...
* communication ^short = "Idiomas do profissional"
* communication ^definition = "Idiomas do profissional"