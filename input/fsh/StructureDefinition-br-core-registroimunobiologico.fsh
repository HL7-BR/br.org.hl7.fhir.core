Profile: br-core-registroimunobiologico
Parent: http://hl7.org/fhir/StructureDefinition/Composition
Id: br-core-registroimunobiologico
...
* type.coding[0].system = "http://hl7.org/fhir/R4/valueset-doc-typecodes.html"
...
* type.coding[0].display = "História de Imunizações"
...
* event.code.coding[0].code = "11369-6"
* event.code.coding[0].display = "Histórico de Imunizações"
...
* section.code.coding[0].code = "11369-6"
* section.code.coding[0].display = "Registro de Imunizações"
