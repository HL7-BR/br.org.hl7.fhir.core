...
* identifier[cns].assigner.id ^short = "Identificador único para referencia cruzada"
* identifier[cns].assigner.id ^definition = "Identificador único para referencia cruzada"
...
* identifier[cpf].assigner.id ^short = "Identificador único para referencia cruzada"
* identifier[cpf].assigner.id ^definition = "Identificador único para referencia cruzada"
...
* identifier[passaporte].assigner.id ^short = "Identificador único para referencia cruzada"
* identifier[passaporte].assigner.id ^definition = "Identificador único para referencia cruzada"
...
* identifier[registroEstrangeiro].assigner.id ^short = "Identificador único para referencia cruzada"
* identifier[registroEstrangeiro].assigner.id ^definition = "Identificador único para referencia cruzada"
...
* managingOrganization ^short = "Organizaç* id ^short = "Identificador lógico deste artefato."
...
* identifier ^definition = "Identificadores externos para este recurso"ão responsável pelo paciente"
