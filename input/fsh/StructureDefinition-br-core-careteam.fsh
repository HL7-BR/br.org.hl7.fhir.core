...
* reasonCode ^short = "Por quê a equipe de atendimento existe"
* reasonCode ^definition = "Por quê a equipe de atendimento existe"
* reasonReference ^short = "Por quê a equipe de atendimento existe"
* reasonReference ^definition = "Por quê a equipe de atendimento existe"
