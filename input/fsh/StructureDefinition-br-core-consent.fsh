...
* extension contains BRBaseLegalLGPD named baseLegalLGPD 1..1 MS
...
* extension[baseLegalLGPD].valueCodeableConcept from https://terminologia.saude.gov.br/fhir/ValueSet/BRBaseLegalLGPD (required)
...
* provision.actor.reference only Reference(Device or br-core-organization or br-core-patient or br-core-practitioner or br-core-practitionerrole or br-core-relatedperson)
