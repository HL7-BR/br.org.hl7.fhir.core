...
//* code.coding[0].display = "Pregnancy status"
...
* value[x] 1..1
* valueCodeableConcept ^short = "Conceito definido no sistema de terminologia"
* valueCodeableConcept ^definition = "Conceito definido no sistema de terminologia"
