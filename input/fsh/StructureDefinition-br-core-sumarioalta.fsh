...
* section[diagnosticosAdmissao].focus ^short = "Referência à recurso associado desta seção"
* section[diagnosticosAdmissao].focus ^definition = "Referência à recurso associado desta seção"
...
* section[diagnosticosAvaliados] ^definition = "Seção de Resumo de Diagnósticos Avaliados"
...
* section[prescricaoAlta] ^short = "Seção de Resumo da Prescrição da Alta"
* section[prescricaoAlta] ^definition = "Seção de Resumo da Prescrição da Alta"
...
* section[prescricaoAlta].focus ^short = "Referência à recurso associado desta seção"
* section[prescricaoAlta].focus ^definition = "Referência à recurso associado desta seção"
