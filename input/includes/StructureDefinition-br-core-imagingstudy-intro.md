...
O [br-core-imagingstudy](https://saude.gov.br/fhir/StructureDefinition/br-core-imagingStudy.html) fornece informações sobre um estudo de imagem DICOM e as séries e objetos de imagem nesse estudo. Ele também fornece informações sobre como recuperar essas informações (em um formato DICOM nativo ou em um formato renderizado, como JPEG). O [br-core-imagingstudy](https://saude.gov.br/fhir/StructureDefinition/br-core-imagingStudy.html) é usado para disponibilizar informações sobre todas as partes de um único estudo DICOM.
...
**Cada Perfil [br-core-imagingstudy](https://saude.gov.br/fhir/StructureDefinition/br-core-imagingStudy.html) deve ter:**
...
Cada Perfil [br-core-imagingstudy](https://saude.gov.br/fhir/StructureDefinition/br-core-imagingStudy.html) deve oferecer suporte a:
Não há elementos.

### Limites e relacionamentos

O recurso [br-core-imagingstudy](https://saude.gov.br/fhir/StructureDefinition/br-core-imagingStudy.html) é usado para armazenar imagens DICOM e informações associadas. Use o perfil [Media](https://hl7.org/fhir/R4/media.html) do FHIR R4 para rastrear imagens, vídeo ou áudio não DICOM. O perfil [Binary](https://hl7.org/fhir/R4/binary.html) pode ser usado para armazenar conteúdo arbitrário. [DocumentReference](https://hl7.org/fhir/R4/documentreference.html) permite indexação e recuperação de “documentos” clínicos com metadados relevantes.

Este recurso é referenciado por [ChargeItem](https://hl7.org/fhir/R4/chargeitem.html#ChargeItem), [ClinicalImpression](https://hl7.org/fhir/R4/clinicalimpression.html#ClinicalImpression), [br-core-diagnosticreport](https://saude.gov.br/fhir/StructureDefinition/br-core-diagnosticreport.html) e [br-core-observation](https://saude.gov.br/fhir/StructureDefinition/br-core-observation.html).