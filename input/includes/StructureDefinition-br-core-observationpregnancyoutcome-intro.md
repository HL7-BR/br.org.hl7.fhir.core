...
Para o perfil [br-core-observationpregnancyoutcome](StructureDefinition-br-core-observationpregnancyoutcome) os elementos de dados que são obrigatórios (mandatórios) e os que devem ser suportados (must support) são:
