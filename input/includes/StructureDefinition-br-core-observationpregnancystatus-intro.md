...
Para o perfil [br-core-observationpregnancystatus](https://saude.gov.br/fhir/StructureDefinitions/br-core-observationpregnancystatus) os elementos de dados que são obrigatórios (mandatórios) e os que devem ser suportados (must support) são:
