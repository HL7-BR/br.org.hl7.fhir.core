...
O recurso brasileiro [br-core-medicationdispense](https://saude.gov.br/fhir/StructureDefinition/br-core-medicationdispense) restringe os casos de uso do Recurso FHIR canônico, e deve ser utilizado para dispensação de qualquer medicamento, em qualquer tipo de estabelecimento, mesmo não vinculado ao SUS.

O recurso [br-core-medicationdispense](https://saude.gov.br/fhir/StructureDefinition/br-core-medicationdispense) contempla as seguintes situações de uso:
