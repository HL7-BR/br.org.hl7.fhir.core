...
Os recursos [br-core-careplan](StructureDefinition-br-core-careplan.html) podem ser vinculados a condições ([br-core-condition](StructureDefinition-br-core-condition.html)) específicas, mas também podem ser independentes da condição e, em vez disso, focados em um tipo específico de cuidado (por exemplo, psicológico, nutricional) ou no cuidado prestado por um profissional ou grupo de profissionais específico.
