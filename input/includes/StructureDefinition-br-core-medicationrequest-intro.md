...
O recurso [br-core-medicationrequest](StructureDefinition-br-core-medicationrequest) é utilizado solicitar ou pedir medicamentos para um indivíduo. Este também pode ser utilizado para relatar uma solicitação ou pedido de medicamento de uma organização ou fonte para outra. Ao solicitar suprimentos ou dispositivos quando há um foco no paciente ou instruções sobre seu uso, [SupplyRequest](https://www.hl7.org/fhir/R4/supplyrequest.html) ou [DeviceRequest](https://www.hl7.org/fhir/R4/devicerequest.html) devem ser utilizados. Ao relatar o uso de um medicamento por um paciente, o recurso [br-core-medicationrequest](StructureDefinition-br-core-medicationrequest) deve ser utilizado.
